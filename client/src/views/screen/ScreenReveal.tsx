...
export default function ScreenReveal() {
  ...
  return (
    <main className="screen-shell">
      <header className="screen-header"><div><div className="screen-meta">Question {questionNumber} / {totalQuestions}</div><h1 className="screen-title">{text}</h1></div><div className="screen-meta">{totalAnswered} / {totalParticipants} Answered</div></header>
